...
public class SqlServerClientRepository(IConnectionStringBuilder connectionStringBuilder) : IClientRepository
{
    private readonly string _connectionString = connectionStringBuilder.BuildSqlServerConnectionString();
